package info.kgeorgiy.ja.potekhin.student;
...
public class StudentDB implements GroupQuery {
    ...
    private List<Group> getSortedGroups(final Collection<Student> students,
    ...
    private GroupName getLargestGroup(
    ...
    public GroupName getLargestGroup(final Collection<Student> students) {
        return getLargestGroup(students, List::size, Comparator.naturalOrder());
    }

    @Override
    public GroupName getLargestGroupFirstName(final Collection<Student> students) {
        return getLargestGroup(students, s -> getDistinctFirstNames(s).size(), Comparator.reverseOrder());
    }
    ...
    public List<Group> getGroupsByName(final Collection<Student> students) {
        return getSortedGroups(students, s -> s.stream().sorted(nameComparator).collect(Collectors.toList()));
    }

    @Override
    public List<Group> getGroupsById(final Collection<Student> students) {
        return getSortedGroups(students, Function.identity());
    }
